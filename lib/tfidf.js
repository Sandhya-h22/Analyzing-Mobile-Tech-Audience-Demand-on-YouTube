...
export async function analyseTopicsWithML(demandComments, numTopics = 6) {
  ...
  try {
    ...
    return {
      topics: topics.length ? topics : analyseTopics(demandComments, numTopics).topics,
    ...
    return {
      ...analyseTopics(demandComments, numTopics),
      engine: { mode: "rule-based", stage: "topics", provider: "local-tfidf", model: null },
    };
  }
}
